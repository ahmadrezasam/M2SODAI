...
def test_adversarial_forward():
    print("Testing UDAAdversarialDetector forward pass...")
    ...
    print("Running forward_train (Adversarial UDA mode)...")
    ...
    assert 'loss_adversarial_domain' in losses, "Adversarial domain loss missing!"
    assert 'loss_cls' in losses, "Supervised ROI detection loss missing!"
    
    print("\nTest passed successfully! Adversarial and supervised losses are active.")

if __name__ == '__main__':
    test_adversarial_forward()
