# Self-contained Swin-T FCOS Config for Fold 2
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/home/ahmadreza/Downloads/Research/M2SODAI/baseline_official/runs_swin_hbb/swin_t_hbb_fold_2_20260509'
seed = 0
deterministic = True
